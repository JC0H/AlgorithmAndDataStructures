package dataStr_v2; /******************************************************************************
 *  Compilation:  javac dataStr_v2.StdIn.java
 *  Execution:    java dataStr_v2.StdIn   (interactive test of basic functionality)
 *  Dependencies: none
 *
...
/**
 *  The {@code dataStr_v2.StdIn} class provides static methods for reading strings
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code dataStr_v2.StdIn.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdIn.java">dataStr_v2.StdIn.java</a>
 ...
 *  <pre>
 *  while (!dataStr_v2.StdIn.isEmpty()) {
 *      double value = dataStr_v2.StdIn.readDouble();
 *      dataStr_v2.StdOut.println(value);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (dataStr_v2.StdIn.hasNextChar()) {
 *      char c = dataStr_v2.StdIn.readChar();
 *      dataStr_v2.StdOut.print(c);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (dataStr_v2.StdIn.hasNextLine()) {
 *      String line = dataStr_v2.StdIn.readLine();
 *      dataStr_v2.StdOut.println(line);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  String[] words = dataStr_v2.StdIn.readAllStrings();
 *  </pre>
 *  <p>
 *  <b>Differences with Scanner.</b>
 *  {@code dataStr_v2.StdIn} and {@link Scanner} are both designed to parse
 *  tokens and convert them to primitive types and strings.
 *  The main differences are summarized below:
 *  <ul>
 *  <li> {@code dataStr_v2.StdIn} uses whitespace as the delimiter pattern
 *       that separates tokens.
 *       {@link Scanner} supports arbitrary delimiter patterns.
 *  <li> {@code dataStr_v2.StdIn} coerces the character-set encoding to UTF-8,
 *       which is the most widely used character encoding for Unicode.
 *  <li> {@code dataStr_v2.StdIn} coerces the locale to {@link Locale#US},
 *       for consistency with {@link StdOut}, {@link Double#parseDouble(String)},
 *       and floating-point literals.
 *  <li> {@code dataStr_v2.StdIn} has convenient methods for reading a single
 *       character; reading in sequences of integers, doubles, or strings;
 *       and reading in all of the remaining input.
 *  </ul>
 *  <p>
 *  Historical note: {@code dataStr_v2.StdIn} preceded {@code Scanner}; when
 ...
 *  Windows, and Linux.
 *  The methods in {@code dataStr_v2.StdIn} are <em>blocking</em>, which means that they
 ...
 *  If the input begins with the optional byte-order mask, {@code dataStr_v2.StdIn}
...
final class StdIn {
    ...
    /*** begin: section (1 of 2) of code duplicated from In to dataStr_v2.StdIn. */
    ...
    /*** end: section (1 of 2) of code duplicated from In to dataStr_v2.StdIn. */
    ...
    //// begin: section (2 of 2) of code duplicated from In to dataStr_v2.StdIn,
    ...
    //// end: section (2 of 2) of code duplicated from In to dataStr_v2.StdIn


    // do this once when dataStr_v2.StdIn is initialized
    static {
        resync();
    }

    /**
     * If dataStr_v2.StdIn changes, use this to reinitialize the scanner.
     */
